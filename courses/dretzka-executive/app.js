const pars = [3, 3, 3, 3, 3, 3, 3, 3, 3];
const distances = [335, 248, 300, 262, 220, 225, 238, 181, 238];
...
const mapCoordinates = [
    { x: 0.587, y: 0.487, rot: 165, scale: 6.00 }, // Hole 1
    { x: 0.577, y: 0.626, rot: 182, scale: 6.00 }, // Hole 2
    { x: 0.585, y: 0.774, rot: 166, scale: 6.00 }, // Hole 3
    { x: 0.535, y: 0.893, rot: 113, scale: 6.00 }, // Hole 4
    { x: 0.553, y: 0.908, rot: 296, scale: 6.00 }, // Hole 5
    { x: 0.613, y: 0.815, rot: 11, scale: 6.00 }, // Hole 6
    { x: 0.614, y: 0.696, rot: 359, scale: 6.00 }, // Hole 7
    { x: 0.620, y: 0.595, rot: 15, scale: 6.00 }, // Hole 8
    { x: 0.609, y: 0.483, rot: 359, scale: 6.00 }, // Hole 9
];
...
function addPlayer() {
    ...
    if (name && !players.includes(name)) {
        players.push(name);
        scores[name] = new Array(9).fill(0); // Initialize with 0s
        updatePlayerList();
...
function loadHole(holeIndex) {
    ...
    nextHoleBtn.style.visibility = holeIndex === 9 ? 'hidden' : 'visible';
